...
import os
import random
from character_selection import create_character, display_character_sheet, reallocate_points
from Ch_inventory import manage_inventory
...
def main_menu():
    ...
    while True:
        ...
        print("3. Edit character stats and inventory")
        print("4. Start game")
        print("5. Exit")
